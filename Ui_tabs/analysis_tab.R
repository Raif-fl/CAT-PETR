                ...
                # Split the main panel into multiple tabs. 
                  tabsetPanel(
                    ...
                    tabPanel("Volcano Plot", value="vp_plot",
                             ...
                             shinyWidgets::dropdownButton(tags$h5("Appearance options"), size = "sm",
                                            ...
                                            fluidRow(column(6, colourpicker::colourInput("upreg", "Up-regulated", "red", palette = "limited")),
                                                     column(6, colourpicker::colourInput("downreg", "Down-regulated", "blue", palette = "limited"))),
                                            fluidRow(column(6, colourpicker::colourInput("notsig", "Not-significant", "black", palette = "limited")),
                                                     column(6, colourpicker::colourInput("Additional1", "Searchbar Points", "#9400D3", palette = "limited"))),
                                            ...
                                            tooltip = shinyWidgets::tooltipOptions(title = "Click to alter plot appearance")),
                    ...
                    tabPanel("Scatter Plot", value="sc_plot",
                             shinyWidgets::dropdownButton(tags$h5("Appearance options"), size = "sm",
                                            ...
                                            fluidRow(column(6, colourpicker::colourInput("abvquant", "Above Quantiles", "black", palette = "limited")),
                                                     column(6, colourpicker::colourInput("blwquant", "Below Quantiles", "black", palette = "limited"))),
                                            fluidRow(column(6, colourpicker::colourInput("withquant", "Within Quantiles", "black", palette = "limited")),
                                                     column(6, colourpicker::colourInput("Additional2", "Searchbar points", "#9400D3", palette = "limited"))),
